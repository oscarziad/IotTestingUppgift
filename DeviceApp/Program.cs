...
namespace DeviceApp
{
    ...
    {
        private static DeviceClient deviceClient = DeviceClient.CreateFromConnectionString("HostName=ec-win20-iothub-oscar.azure-devices.net;DeviceId=DeviceApp;SharedAccessKey=SCm3zSbzqRZHrOI48RTGNo4VOEnXjosOdKqKKckBzoI=", TransportType.Mqtt);
